            ...
            'jobs': [
                {
                    ...
                    'dynamic_ip': 1,
                    'varname': 'kibosh',
                    'ephemeral_disk': package.get('ephemeral_disk', get_disk_size_for_chart(package['helm_chart_dir'], package['operator_dir'] if 'operator_dir' in package else None)),
                    ...
                    'post_deploy': True,
                    'lifecycle': 'errand',
                    'ephemeral_disk': package.get('ephemeral_disk', get_disk_size_for_chart(package['helm_chart_dir'], package['operator_dir'] if 'operator_dir' in package else None) * 3),
                    'varname': 'loader',
